				...
				<div class="admin-content-body">
					  <div class="am-cf am-padding am-padding-bottom-0">
				        <div class="am-fl am-cf">
				        	<strong class="am-text-primary am-text-lg">新商品添加</strong>
				        </div>
				      </div>
				
				      <hr>
					 <form action="${pageContext.request.contextPath }/ProductController/addProduct" method="post" class="am-form am-form-horizontal" enctype="multipart/form-data">
					  ...
					  <div class="am-form-group">
					    <div class="am-u-sm-5 am-u-sm-offset-2">
					    	<img id="p-img-f" src="${pageContext.request.contextPath }/img/nopic.gif" class="am-img-thumbnail am-radius" width="200px" height="auto">
					    </div>
					  </div>
					  <div class="am-form-group">
					    <div class="am-u-sm-5 am-u-sm-offset-2">
					      <button type="submit" class="am-btn am-btn-primary">添加新商品</button>
					    </div>
					  </div>
					</form>
